...
void    dbg_dumpW(int w[44]) {
    ...
    std::cout << std::hex; /** 启用十六进制输出 */
    for (int i = 0; i < Nw; i++) std::cout << std::setw(2) << std::setfill('0') << col0[i] << " ";
    std::cout << std::endl;
    for (int i = 0; i < Nw; i++) std::cout << std::setw(2) << std::setfill('0') << col1[i] << " ";
    std::cout << std::endl;
    for (int i = 0; i < Nw; i++) std::cout << std::setw(2) << std::setfill('0') << col2[i] << " ";
    std::cout << std::endl;
    for (int i = 0; i < Nw; i++) std::cout << std::setw(2) << std::setfill('0') << col3[i] << " ";
